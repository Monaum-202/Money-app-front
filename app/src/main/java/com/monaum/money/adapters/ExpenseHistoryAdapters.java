...
public class ExpenseHistoryAdapters extends ArrayAdapter<AddExpence1> {

    public ExpenseHistoryAdapters(@NonNull Context context, ArrayList<AddExpence1> dataArrayList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        AddExpence1 listData = getItem(position);
